...
const articles = [
  // { id:1, title:"", category:"IT Strategy & Transformation", date:"", readTime:"", excerpt:"", body:`` },
];
...
function closeArticle() {
  ...
  document.getElement  document.getElementById('category-filters').style.display = 'flex';
  document.getElementById('article-reader').style.display = 'none';
  window.scrollTo(0, 0);
}

// Module executes after DOM is ready
renderArticles();